...
1. Start the app.  
2. Type a task in the input and press **Enter** or click `+` to add it.  
3. Use the tabs to filter tasks by status.  
4. Click **Done** to mark a task as completed.  
5. Click **Delete** to remove a task.  
6. Toggle theme with the top-right button — theme persists across reloads.
